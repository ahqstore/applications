...

    {
      layer === 7 && (
        <>
          ...
          <p style={{ "color": "white" }}>There's more to the story, <span className="px-2 my-1 border-2 border-white rounded-md">look out</span> into the world to find the answer</p>
